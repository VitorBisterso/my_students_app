...
describe('Auth actions', () => {
  describe('Register', () => {
    ...
    it('should create an action due to a successful register user request', () => {
      const expectedAction = {
        type: Types.REGISTER_SUCCESS
      };
      expect(Actions.registerSuccessAction()).toEqual(expectedAction);
    });
    it('should create an action due to a failed register user request', () => {
  ...
  describe('Login', () => {
    ...
    it('should create an action due to a successful login request', () => {
    ...
    it('should create an action due to a failed login request', () => {
